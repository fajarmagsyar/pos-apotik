                            ...
                            <div class="col-lg-5">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn">
                                        <button onclick="tampilBarcodeScanner()" class="btn btn-danger btn-flat"
                                            type="button"><i class="fa fa-qrcode"></i></button>
    ...
    <script>
        $(document).ready(function(event) {
            ...
            Quagga.onDetected(function(result) {
                if (result.codeResult.code) {
                    $("#kode_produk").val(result.codeResult.code);
                    Quagga.stop();
                    setTimeout(function() {
                        $("#livestream_scanner").modal("hide");
                    }, 1000);
                    pilihProduk(1, $("#kode_produk").val());
                }
            });
        ...
        $("#kode_produk").keypress(function(e) {
            if (e.which == 13) {
                ...
                // alert($("#kode_produk").val());
                $.ajax({
                    type: 'GET', //THIS NEEDS TO BE GET
                    url: '/produk/ambilSalahSatu/' + $("#kode_produk").val(),
                    success: function(data) {
                        pilihProduk(data.id_produk, $("#kode_produk").val());
                    },
                    error: function() {
